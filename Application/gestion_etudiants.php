...
<div align="center">
  <div>
    ...
    <table width="500" border="0" class="left">
      ...
      <tr>
        <td height="49">
				<div class="connexion"  align="center"><a href="ajouter_etudiant.php">Ajouter un nouveau etudiant</a></div>
           
 </td>
      </tr>
      <tr>
        <td height="49">
				<div class="connexion"  align="center"><a href="rechercher_etudiant.php">Rechercher un etudiant</a></div>
      ...
      <tr>
        <td height="49"><div class="connexion"  align="center"><a href="rechercher_etudiant.php">Modifier un  etudiant</a></div>
           </td>
      </tr>
       <tr>
        <td height="49"><div class="connexion"  align="center"><a href="rechercher_etudiant.php">Supprimer un  etudiant</a></div>
           </td>
      </tr>
    </table>
...
<tr valign="bottom" bgcolor="#D0E0ED">
	<td background="images/b_fon_a.gif" bgcolor="#FFFFFF" width="160"></td>
</tr>
</table>
