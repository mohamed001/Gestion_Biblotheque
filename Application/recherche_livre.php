...
<div align="center">
  <div>
    ...
    <table height="300" width="500" border="0" class="left">
      <tr>
        <th class="connexion" scope="col" height="20">Entrer l'ISBN du livre :</th>
      </tr>
      <tr>
        <td height="200"><form action='modifier_livre.php'  method="post" >
        <table height="200">
        <tr >
    ...
    <td width="405"><input type="text" width="300" name="isbn"/></td>
  </tr>
  <tr>
    <td width="169"></td>
...
if( isset($_POST['rechercher'])){
	...
	$result1="select * from livre where ISBN=".$_POST["isbn"];
if(mysql_query($result1))
		   {
			   ?> 
			    <script type="text/javascript">   alert(' <?php echo $result1['isbn']."   ".$result1['isbn']; ?>' )</script> 
				<?php }
           else {  
