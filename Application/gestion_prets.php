...
<div align="center">
  <div>
    ...
    <table width="500" border="0" class="left">
      ...
      <tr>
        <td height="49">
				<div class="connexion"  align="center"><a href="emprunt.php">Emprunt d'un livre</a></div>
           
 </td>
      </tr>
      <tr>
        <td height="49">
				<div class="connexion"  align="center"><a href="retour.php">Retour d'un livre</a></div>
      ...
      <tr>
        <td height="49"><div class="connexion"  align="center"><a href="liste_livres_emprunt.php">liste des livre empruntés</a></div>
           </td>
      </tr>
       <tr>
        <td height="49"><div class="connexion"  align="center"><a href="liste_etudiants_sanct.php">Liste des etudiants sanctionnés</a></div>
           </td>
      </tr>
    </table>
