  ...
  <div>
    ...
    <table width="500" border="0" class="left">
      ...
      <tr>
        ...
        <tr>
        <td width="20%" class="left" >CNE</td>
        <td width="20%" class="left">Nom et prénom</td>
        <td width="20%" class="left">Specialité</td>
        <td width="20%" class="left">date début sanctionnement</td>
        <td width="20%" class="left">durée</td>
        </tr>
...
$sql = " SELECT etudiant.cne, etudiant.Nom_etudiant, etudiant.prenom_etudiant,niveau.libelle_niveau, filiere.libelle_filiere, sanctionnement2.date_debut_sct,sanctionnement2.duree  from sanctionnement2, etudiant,filiere,niveau where sanctionnement2.cne=etudiant.cne and etudiant.id_niveau=niveau.id_niveau and etudiant.id_filiere=filiere.id_filiere"; 
$result = mysql_query($sql) or die("Requete pas comprise"); 
while ($row=mysql_fetch_array($result)) 
{ 
echo"<tr><td>$row[0]</td><td>$row[1] $row[2]</td><td>$row[3] $row[4]</td><td>$row[5]</td><td>$row[6] j</td></tr>"; 
} 
?>
