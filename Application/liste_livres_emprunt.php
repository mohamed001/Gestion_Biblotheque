...
<tr valign="bottom">
  ...
  <tr valign="bottom">
   <td width="155" bgcolor="#01B0F0"  ><p class="menu01" ><a href="index.php">Accueil</a></p></td>
    ...
    <td  width="155" background="images/b_fon_a.gif"><p class="menu01" ><a href="gestion_prets.php">Prêt</a></p></td>
  ...
  <div>
    ...
    <table width="500" border="0" class="left">
      ...
      <tr>
        ...
        <tr>
        <td width="20%" class="left" >Code à barre</td>
        <td width="20%" class="left">Titre</td>
        <td width="20%" class="left">Etudiant</td>
        <td width="20%" class="left">Spécialité</td>
        <td width="20%" class="left">date_emprunt</td>
        </tr>
...
$sql = " SELECT emprunter.code_barre, livre.titre, etudiant.nom_etudiant, etudiant.prenom_etudiant, niveau.libelle_niveau, filiere.libelle_filiere, emprunter.date_emprunt   from emprunter, etudiant,filiere,niveau, livre,exemplaire where emprunter.cne=etudiant.cne and etudiant.id_niveau=niveau.id_niveau and etudiant.id_filiere=filiere.id_filiere and livre.isbn=exemplaire.isbn and emprunt.code_barre=exemplaire.code_barre "; 
$result = mysql_query($sql) or die("Requete pas comprise"); 
while ($row=mysql_fetch_array($result)) 
{ 
echo"<tr><td>$row[0]</td><td>$row[1]</td><td>$row[2] $row[3]</td><td>$row[4] $row[5]</td><td>$row[6] j</td></tr>"; 
} 
?>
				...
				<div style="overflow:auto" class="connexion"  align="center"><a href="emprunt.php"></a></div>
...
<tr valign="bottom" bgcolor="#D0E0ED">
	<td  background="images/b_fon_a.gif"bgcolor="#FFFFFF"></td>
</tr>
</table>
